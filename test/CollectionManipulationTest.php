...
class CollectionManipulationTest extends TestCase
{
    ...
    {
        $bar1 = new Mock\Bar(1, 'a');
        $bar2 = new Mock\Bar(2, 'b');
        $bar3 = new Mock\Bar(3, 'c');
        $barCollection = new Mock\BarCollection([$bar3, $bar2, $bar1]);
    ...
    {
        $bar1 = new Mock\Bar(1, 'c');
        $bar2 = new Mock\Bar(2, 'b');
        $bar3 = new Mock\Bar(3, 'a');
        $barCollection = new Mock\BarCollection([$bar1, $bar2, $bar3]);
    ...
    public function testSortWholeObject(): void
    {
        ...
        $bar2 = new Mock\Bar(2, 'b');
        $bar3 = new Mock\Bar(3, 'c');
        $barCollection = new Mock\BarCollection([$bar2, $bar1, $bar3]);
    ...
    {
        $bar1 = new Mock\Bar(1, 'a');
        $bar2 = new Mock\Bar(1, 'b');

        $barCollection = new Mock\BarCollection([$bar1, $bar2]);

        $this->expectException(InvalidPropertyOrMethod::class);
        $this->expectExceptionMessage('Method or property "unknown" not defined in PhayneTest\Collection\Mock\Bar');
    ...
    public function testWhereWithMultipleObjectMatches(): void
    {
        ...
        $bar2 = new Mock\Bar(2, 'b');
        $bar3 = new Mock\Bar(3, 'c');
        $barCollection = new Mock\BarCollection([$bar1, $bar2, $bar3, $bar2]);
    ...
    {
        $bar1 = $this->prophesize(Mock\Bar::class);
        $bar1->getName()->shouldBeCalled();
        $bar2 = $this->prophesize(Mock\Bar::class);
        $bar2->getName()->shouldBeCalled();

        $barCollection = new Mock\BarCollection([$bar1->reveal(), $bar2->reveal()]);

        $mapCollection = $barCollection->map(fn (Mock\Bar $item): string => $item->getName());
    ...
    public function testReduceShouldRunOverEachItem(): void
    {
        ...
        $reduced = $barCollection->reduce(
            fn (string $carry, Mock\Bar $item): string => trim("$carry {$item->getName()}"),
            '',
        );
    ...
    public function testReduceShouldAllowNullInitialValue(): void
    {
        ...
        $bar2 = new Mock\Bar(2, 'b');
        $bar3 = new Mock\Bar(3, 'c');
        $bar4 = new Mock\Bar(4, 'd');

        $barCollection = new Mock\BarCollection([$bar2, $bar3, $bar1, $bar4]);

        // Reduced should be the item with the lowest scoring name value.
        $reduced = $barCollection->reduce(
            function (?Mock\Bar $carry, Mock\Bar $item): Mock\Bar {
                if ($carry === null) {
                    return $item;
                }
    ...
    {
        $barCollection = new Mock\BarCollection();
    ...
    public function testDiffShouldRaiseExceptionOnDiverseCollections(): void
    {
        ...
        $this->expectExceptionMessage('Collection must be of type PhayneTest\Collection\Mock\BarCollection');

        /**
         * @psalm-suppress InvalidArgument
         */
        $barCollection->diff(new Mock\FooCollection());
    }
    ...
    public function testDiff(): void
    {
        ...
        $barCollection1 = new Mock\BarCollection([$bar1]);
        $barCollection2 = new Mock\BarCollection([$bar1, $bar2]);
        $barCollection3 = new Mock\BarCollection([$bar2, $bar1]);
    ...
    public function testDiffGenericCollection(): void
    {
        ...
        $barCollection1 = new Collection(Mock\Bar::class, [$bar1]);
        $barCollection2 = new Collection(Mock\Bar::class, [$bar1, $bar2]);
    ...
    public function testIntersectShouldRaiseExceptionOnDiverseCollections(): void
    {
         ...
         * @psalm-suppress InvalidArgument
         */
        $barCollection->intersect(new Mock\FooCollection());
    }
    ...
    public function testIntersect(): void
    {
        ...
        $barCollection1 = new Mock\BarCollection([$bar1, $bar2]);
        $barCollection2 = new Mock\BarCollection([$bar1, $bar2, $bar3]);
        $barCollection3 = new Mock\BarCollection([$bar3, $bar2, $bar1]);
    ...
    public function testMergeShouldRaiseExceptionOnDiverseCollection(): void
    {
        ...
        $this->expectException(CollectionMismatchException::class);
        $this->expectExceptionMessage(
            'Collection with index 1 must be of type PhayneTest\Collection\Mock\BarCollection',
        );

        /**
         * @psalm-suppress InvalidArgument
         */
        $barCollection->merge(new Mock\BarCollection(), new Mock\FooCollection());
    }
    ...
    public function testMerge(): void
    {
        ...
        $barCollection1 = new Mock\BarCollection([$bar1]);
        $barCollection2 = new Mock\BarCollection([$bar2]);
        $barCollection3 = new Mock\BarCollection([$bar3]);
    ...
    public function testMergeWhenTheSameObjectAppearsInMultipleCollections(): void
    {
        ...
        $barCollection1 = new Mock\BarCollection([$bar1]);
        $barCollection2 = new Mock\BarCollection([$bar2, $bar1]);
        $barCollection3 = new Mock\BarCollection([$bar3, $bar2]);
    ...
    public function testMergeFunctionalityWithKeys(): void
    {
        ...
        $barCollection1 = new Mock\BarCollection(['a' => $bar1]);
        $barCollection2 = new Mock\BarCollection(['b' => $bar2, 'c' => $bar1]);
        $barCollection3 = new Mock\BarCollection(['c' => $bar3, 'd' => $bar2]);
    ...
    public function testMergeGenericCollection(): void
    {
        ...
        $barCollection1 = new Collection(Mock\Bar::class, [$bar1]);
        $barCollection2 = new Collection(Mock\Bar::class, [$bar2]);
    ...
    {
        $bar1 = new Mock\Bar(1, 'Jane');
        $bar2 = new Mock\Bar(2, 'John');
        $bar3 = new Mock\Bar(3, 'Janice');
        ...
        $names = $barCollection->map(fn (Mock\Bar $bar): string => $bar->getName());

        $ids = $barCollection->map(fn (Mock\Bar $bar): int => $bar->getId());
