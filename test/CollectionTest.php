...
use Phayne\Collection\Exception\NoSuchElementException;
...
class CollectionTest extends TestCase
{
    public function testConstructorSetsType(): void
    {
        ...
        $this->assertSame('string', $collection->type());
    }
    ...
    {
        $fooCollection = new Mock\FooCollection();

        $fooCollection[] = new Mock\Foo();
        $fooCollection[] = new Mock\Foo();
        $fooCollection[] = new Mock\Foo();

        $this->expectException(InvalidArgumentException::class);
        $this->expectExceptionMessage('Value must be of type ' . Mock\Foo::class);
    ...
    {
        $bar1 = new Mock\Bar(1, 'a');
        $barCollection = new Mock\BarCollection([$bar1]);

        $this->expectException(InvalidPropertyOrMethod::class);
        $this->expectExceptionMessage('Method or property "fu" not defined in PhayneTest\Collection\Mock\Bar');
    ...
    public function testSerializable(): void
    {
        ...
        $this->assertInstanceOf(Mock\BarCollection::class, $barCollection2);
        $this->assertContainsOnlyInstancesOf(Mock\Bar::class, $barCollection2);
